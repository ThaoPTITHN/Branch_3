...
//----------------------MQTT-------------------------
var options = {
    host: 'd5fc714aa72242a391917364b43d3b33.s1.eu.hivemq.cloud',
    port: 8883,
    protocol: 'mqtts',
    username: 'vuongvietthaob18dcdt237@gmail.com',
    password: 'VuongVietThaoB18DCDT237'
}
var client = mqtt.connect('mqtt://broker.hivemq.com:1883',{clientId: 'clientId-thaovv'});


// // initialize the MQTT clientq 'mqtt://broker.hivemq.com:1883',{clientId: 'clientId-vn5n6NKqX8'}
// // declare topics
var topic1 = "thaovv/livingroomLight";
var topic2 = "thaovv/livingroomAirConditioner";
var topic3 = "thaovv/television";
var topic4 = "thaovv/bedroomLight";
var topic5 = "thaovv/bedroomAirConditioner";
var topic6 = "thaovv/airVent";

var topic_list = ["thaovv/home/temperature-humidity"];
...
// var temp_graph = [];
// var date_graph = [];
client.subscribe("thaovv/home/temperature-humidity");
var m_time
var newTemp
var newHumi
var newLight
...
client.on('message', function (topic, message) {
    ...
    if (topic == "temperature-humidity123") {
